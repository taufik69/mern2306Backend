...
const orderRoutes = require("../Routes/api/order.ApiRoutes.js");
const paymentRoutes = require("../Routes/api/payment.apiRoutes.js");
...
_.use(process.env.BASE_URL, orderRoutes);
_.use(process.env.BASE_URL, paymentRoutes);
